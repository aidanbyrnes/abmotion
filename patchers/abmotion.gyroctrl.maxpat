        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 655.0, 527.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 650.0, 470.0, 53.0, 22.0 ],
                    "text": "rad2deg"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 657.0, 433.0, 29.5, 22.0 ],
                    "text": "f"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 612.0, 433.0, 29.5, 22.0 ],
                    "text": "+ 0."
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 543.0, 644.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
