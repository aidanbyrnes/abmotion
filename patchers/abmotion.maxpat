        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 765.0, 181.0, 41.0, 22.0 ],
                    "text": "unjoin"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 367.0, 25.0, 46.0, 22.0 ],
                    "text": "port $1"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 109.0, 431.0, 45.0, 22.0 ],
                    "text": "!/ 1000"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 15.0, 243.0, 77.0, 22.0 ],
                    "text": "route /m /r /b"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 15.0, 25.0, 204.0, 22.0 ],
